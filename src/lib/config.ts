...
export namespace MergedConfig {
  ...
  export function merge(
    ...
    const excludeMethodNames = [
      ...
      ...(localConfig?.excludeMethodNames ??
        globalConfig?.excludeMethodNames ??
        []),
    ];
    const includeMethodNames = [
      ...defaultConfig.includeMethodNames,
      ...(localConfig?.includeMethodNames ??
        globalConfig?.includeMethodNames ??
        []),
    ];
    ...
    return {
      ...
      failIfMockNotProvided:
        localConfig?.failIfMockNotProvided ??
        globalConfig?.failIfMockNotProvided ??
        defaultConfig.failIfMockNotProvided,
    };
  }
}
